...
from nolanlab_ephys.common_paths import  eddie_active_projects, eddie_chris_data_folder, eddie_chris_deriv_folder
import os
...
if data_folder is None:
    data_folder = eddie_chris_data_folder
data_folder = Path(data_folder)

deriv_folder = parser.parse_args().deriv_folder
if deriv_folder is None:
    deriv_folder = eddie_chris_deriv_folder
...
for session in sessions:
    stageout_dict[deriv_folder / f"M{mouse:02d}/D{day:02d}/{session}/{protocol}"] = eddie_active_projects / "components_real_data/Wolf_M5_D4/"
