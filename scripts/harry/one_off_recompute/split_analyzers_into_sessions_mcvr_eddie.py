...
for day in days:
    ...
    sessions = list(rec_samples[['one_name','two_name']].values[0])
    recording_paths = filepath_from_mouse_day_sessions(mouse, day, sessions, "scripts/harry/harry_filepaths.csv")
